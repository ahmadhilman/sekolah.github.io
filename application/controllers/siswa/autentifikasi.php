...
class Autentifikasi extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->load->view('autentifikasi/login_siswa');
    ...
    private function _login()
    {
        ...
        $siswa = $this->ModelSiswa->cekData(['nisn' => $nisn])->row_array();
        ...
        if ($siswa) {
            ...
            $this->session->set_flashdata('pesan', '<div class="alert alert-danger alert-message" role="alert">Siswa tidak terdaftar!!</div>');
