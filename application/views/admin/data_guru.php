              ...
              <div class="card">
                 <div class="card-header card-header-info">
                  <p class="card-category">            
                    <a href="" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#guruBaruModal"><i class="material-icons"></i> Tambahkan</a></p>
                </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <picture>
                                    ...
                                    <img src="<?= base_url('assets/img/guru/') . $a->image; ?>" class="img-fluid img-thumbnail" alt="..." style="width:60px;height:80px;">
                                </picture>
                            </td>
                            <td><?= $a->jk; ?></td>
                           ...
                           <td><?= $a->jabatan; ?></td>
                          <td><?= $a->ajar; ?></td>
                          <td> <a href="<?= base_url('admin/guru/ubahGuru/').$a->nip;?>">                    <div class="btn btn-primary btn-sm"><i class="fas fa-edit"></i></div></a>
               <a href="<?= base_url('admin/guru/hapusGuru/').$a->nip;?>" onclick="return confirm('Kamu yakin akan menghapus <?= $judul.' '.$a->nama;?> ?');">
