              ...
              <div class="card">
                 <div class="card-header card-header-warning">
                  <p class="card-category">            
                    <a href="" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#jabatanBaruModal"><i class="material-icons"></i> Tambahkan</a></p>
                </div>
                ...
                <tbody>
                    ...
                    foreach ($jabatan as $a) { ?>
                        <tr>
                            <th scope="row"><?= $i++; ?></th>
                            <td><?= $a['jabatan']; ?></td>
                        <td> <a href="<?= base_url('admin/staf/ubahJabatan/').$a['id'];?>">                    <div class="btn btn-primary btn-sm"><i class="fas fa-edit"></i></div></a>
               <a href="<?= base_url('admin/staf/hapusJabatan/').$a['id'];?>" onclick="return confirm('Kamu yakin akan menghapus <?= $judul.' '.$a['jabatan'];?> ?');">
...
<!-- End of Main Content -->
<div class="modal fade" id="jabatanBaruModal" tabindex="-1" role="dialog" aria-labelledby="jabatansBaruModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="jabatanBaruModalLabel">Tambah Jabatan</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form action="<?= base_url('admin/staf'); ?>" method="post" enctype="multipart/form-data">
