        <div class="top-content">
            ...
            <?= $this->session->flashdata('pesan'); ?>
                <div class="row">
                    <div class="section-title col-sm-8 col-sm-offset-2 text">
                        <h2>PENDAFTARAN <strong>SISWA/I</strong> BARU</h2>
                        <h2>Tahun Ajaran <?= date('yy') ?>/<?= date('Y', strtotime('+' . '1' . ' year', strtotime('Y')))  ?></h2>
                        <hr>
                    </div>
